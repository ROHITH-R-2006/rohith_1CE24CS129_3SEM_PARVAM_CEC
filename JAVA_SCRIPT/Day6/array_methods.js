...
let employees=[
    {id:1,empName:"Akshay",experience:2.3},
    {id:1,empName:"Pavan",experience:3.5},
    {id:1,empName:"Morty",experience:4.3},
]
console.log(employees);

// find() method is used to get the complete result
// findIndex() method is used to get the Index// some() method is used to check atleast some match is found for the given condition
...
let findExpExp = employees.some(employee => employee.experience>3);
console.log(findExpExp);

let findEmpExp1 = employees.every(employee => employee.experience>3);
console.log(findEmpExp1);

let findEmpExp2 = employees.every(employee => employee.experience>2);
console.log(findEmpExp2);
...
// slice: To show only desired result,does not affect original array
...
console.log(`Numbers after slice: ${numbers.slice(-4, -1)}`);
...
// splice
// Syntax:
// array.splice(where, how many to remove,new element to add)
